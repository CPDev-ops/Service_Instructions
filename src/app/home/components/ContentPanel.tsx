...
export default function ContentPanel({ source, title }: HookInstructiveProps) {

    const htmlRef = useRef<HTMLDivElement>(null)

    return (
        <div className="lg:w-1/2 overflow-y-auto bg-white rounded-3xl shadow-lg lg:ml-4 my-8 lg:my-0">
